...
const cards = [
  {
    ...
    warnhinweise: [
      // spezielle Hinweise könntest du später ergänzen
    ]
  },
  {
    id: "mistel",
  ...
  },
  {
    ...
    warnhinweise: [
      "Vorsicht bei Hautverletzungen (Überempfindlichkeitsreaktionen)",
      "Vorsicht bei fieberhaften Erkrankungen",
      "Vorsicht bei Herzproblemen (anregende ätherische Öle)"
    ]
  },
  {
    id: "ginkgo",
  ...
  },
  {
    ...
    warnhinweise: [
      // ggf. Präparatehinweise ergänzen
    ]
  },
  {
    id: "buchweizen",
  ...
  },
  {
    ...
    warnhinweise: [
      // keine speziellen Hinweise im Foliensatz
    ]
  },
  {
    id: "preiselbeere",
  ...
  },
  {
    ...
    germanName: "Kürbis",
    levels: ["einfach", "mittel", "schwer"],
    drogenParts: ["Kürbissamen", "Curcubitae", "semen"],
  ...
  },
  {
    ...
    anwendung: [
      "volksmedizinisch bei Beschwerden beim Harnlassen",
      "volksmedizinisch bei gutartiger Prostatavergrößerung"
    ],
    warnhinweise: [
      // keine speziellen Hinweise im Foliensatz
    ]
  ...
  },
  {
    ...
    warnhinweise: [
      "Nicht bei Schwangerschaft anwenden",
      "Nicht bei Nierenerkrankungen (Reizung der Niere)"
    ]
  },
  {
    id: "arnika",
  ...
  },
  {
    ...
    warnhinweise: [
      // keine besonderen Angaben in der Präsentation – bei Bedarf ergänzen
    ]
  },
  {
    id: "kamille",
    ...
    warnhinweise: [
      // z.B. Allergien bei Korbblütler-Empfindlichkeit könntest du später ergänzen
    ]
  },
  {
    id: "hamamelis",
    ...
    warnhinweise: [
      // nicht speziell angegeben – ggf. später ergänzen
    ]
  },
  {
    id: "eichenrinde",
    ...
    warnhinweise: [
      // besondere Warnhinweise kannst du bei Bedarf ergänzen
    ]
  },
  {
    id: "eukalyptus",
  ...
  },
  {
    ...
    germanName: "Efeu",
    levels: ["einfach", "mittel", "schwer"],
    drogenParts: ["Efeublätter", "Hederae", "folium"], // Präsentation: Hedera folium
    ...
    warnhinweise: [
      // Präsentation enthält hier keine expliziten Hinweise – ggf. später ergänzen
    ]
  },
  {
    id: "eibisch",
  ...
  },
  {
    ...
    germanName: "Primel",
    levels: ["einfach", "mittel", "schwer"],
    // zwei Drogen – ich trenne nach Blüte/Wurzel
  ...
  // Weitere Karten aus dem Kartenset hier ergänzen
];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initLevel() {
    ...
    // +1, weil currentIndex bei 0 startet
  ...
  // =============== Drag & Drop ===============
    ...
    // 1) richtige Optionen der aktuellen Karte
    ...
    // 2) Für Mittel: pro Gruppe genau gleich viele falsche Distraktoren wie richtige
    if (level === "mittel") {
  ...
  function checkAnswers() {
    ...
    if (currentLevel === "einfach") {
      ...
      hint = "Stell dich jetzt der Stufe SCHWER.";
    } else {
      message = "Großartig, du hast alle Karten auf der SCHWEREN Stufe gemeistert!";
      hint = "Du beherrschst dieses Kartenset – WOW!";
    }
    ...
    if (restartRunBtn) {
      restartRunBtn.addEventListener("click", () => {
        // neuen zufälligen Durchlauf auf gleicher Stufe starten
        const levelCards = getLevelCards(currentLevel);
        shuffledIndices = shuffleArray(levelCards.map((_, i) => i));
        currentIndex = 0;
        renderCurrentCard();
  ...
  function nextCard() {
    ...
    // Prüfen, ob wir am Ende angekommen sind
